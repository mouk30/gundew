...
export const SAFETY_GUARANTEES = [
  ...
  {
    id: 'pickup-guarantee',
    title: '포르쉐 & 고급세단 안심 픽업',
    subtitle: '건대/성수/잠실/강남 전 지역 포르쉐 상시대기',
    desc: '예약 고객님께 전담 기사가 배정되어 포르쉐 및 고급 세단으로 약속 장소에서 매장 앞까지 안전하고 럭셔리하게 무료로 모십니다. 늦은 시간 귀가 동선까지 철저히 케어해 드립니다.',
    icon: 'Car',
    badge: '포르쉐 픽업'
  }
];
